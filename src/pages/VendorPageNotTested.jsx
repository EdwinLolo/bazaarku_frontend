        ...
        const fetchVendor = async () => {
            try {
                ...
                if (data.success && data.data) {
                    const isVendor = data.data.user_id === user?.id && user?.role === 'vendor';
                    ...
                    <div className="relative bg-white/90 backdrop-blur-md rounded-2xl p-6 shadow-lg max-w-3xl">
                        {vendor.isVendor && (
                            <button
                                ...
                                className="absolute top-4 right-4 bg-blue-600 text-white p-2 rounded-full shadow-lg hover:bg-blue-700 transition-colors z-20"
