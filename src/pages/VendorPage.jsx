        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50 p-4">
                <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center max-w-md w-full border border-gray-100">
                    ...
                    <h2 className="text-xl font-bold text-gray-800 mb-2">Error Loading Vendor</h2>
                    <p className="text-gray-600 text-center mb-6">{error}</p>
                    <button
                        className="px-6 py-3 bg-blue-600 text-white rounded-full shadow hover:bg-blue-700 transition duration-300 ease-in-out font-medium flex items-center"
    ...
    if (!vendor) {
        return <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50">
            <div className="text-center p-8 bg-white rounded-xl shadow-lg">
                ...
                <p className="text-gray-600 mt-2">The vendor you're looking for is not available.</p>
            </div>
        </div>;
    }
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50">
            ...
            <div className="relative h-106 overflow-hidden">
                <div
                    ...
                    style={{
                        backgroundImage: `url(${vendor.banner || 'https://images.unsplash.com/photo-1519671482749-fd09be7ccebf?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80'})`,
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-6">
                            ...
                            <div>
                                ...
                                <div className="flex items-center mt-2 text-blue-600">
                                    ...
                                    <span className="font-medium">{vendor.location.charAt(0).toUpperCase() + vendor.location.slice(1)}</span>
                                </div>
                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                    ...
                    <div className="border-b border-gray-200">
                        <div className="flex overflow-x-auto">
                            <button
                                className={`px-6 py-4 font-medium text-sm md:text-base cursor-pointer ${activeTab === 'about' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-gray-700'}`}
                                onClick={() => setActiveTab('about')}
                            >
                                About Us
                            </button>
                            <button
                                className={`px-6 py-4 font-medium text-sm md:text-base cursor-pointer ${activeTab === 'events' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-gray-700'}`}
                                onClick={() => setActiveTab('events')}
                            >
                                Events
                            </button>
                            <button
                                className={`px-6 py-4 font-medium text-sm md:text-base cursor-pointer ${activeTab === 'contact' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-gray-700'}`}
                    ...
                    <div className="p-6 md:p-8">
                        ...
                        {activeTab === 'about' && (
                            <div>
                                ...
                                <p className="text-gray-700 leading-relaxed mb-6">
                                    {vendor.desc || "We specialize in creating unforgettable experiences for all types of events. With over 10 years of experience, our team of professionals brings creativity, expertise, and attention to detail to every project we undertake."}
                                </p>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                                    {[1, 2, 3].map(item => (
                                        <div key={item} className="bg-blue-50 rounded-xl p-5">
                                            ...
                                            <h3 className="font-bold text-lg text-gray-900 mb-2">Premium Quality (Dummy)</h3>
                                            <p className="text-gray-600">We use only the finest materials and ingredients for all our services.</p>
                                        </div>
                                    ))}
                                </div>

                                <div className="border-t border-gray-200 pt-6">
                                    <h3 className="font-bold text-xl text-gray-900 mb-4">Our Team</h3>
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                        {[1, 2, 3, 4].map(member => (
                                            <div key={member} className="text-center">
                                                <div className="bg-gray-200 border-2 border-dashed rounded-xl w-16 h-16 mx-auto mb-3" />
                                                <h4 className="font-medium text-gray-900">Team Member Dummy {member}</h4>
                        ...
                        {activeTab === 'events' && (
                            <div>
                                <div className="mb-6">
                                    <h2 className="text-2xl font-bold text-gray-900">Our Events</h2>
                                </div>
                                ...
                                {vendor.event.length === 0 ? (
                                    <div className="text-center py-12">
                                        ...
                                        <p className="text-gray-600 max-w-md mx-auto">
                                            This vendor doesn't have any scheduled events at the moment. Check back later!
                                        </p>
                                    </div>
                                ) : (
                                ...
                                <div>
                                    ...
                                    <div className="space-y-5">
                                        ...
                                        <div className="flex items-start">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-gray-600">{vendor.location.charAt(0).toUpperCase() + vendor.location.slice(1)}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-start">
                                            ...
                                            <div>
                                                ...
                                                <a href={vendor.website || "#"} className="text-blue-600 hover:underline">www.{vendor.name.toLowerCase().replace(/\s+/g, '')}.com</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-8">
                                        ...
                                        <div className="flex space-x-4">
                                            <a href={`https://instagram.com/${vendor.insta}`} className="bg-gray-100 p-3 rounded-full text-pink-600 hover:bg-pink-100 transition-colors">
                                                <FaInstagram className="w-5 h-5" />
                                            </a>
                                            <a href="#" className="bg-gray-100 p-3 rounded-full text-blue-600 hover:bg-blue-100 transition-colors">
                                                <FaFacebook className="w-5 h-5" />
                                            </a>
                                            <a href="#" className="bg-gray-100 p-3 rounded-full text-sky-500 hover:bg-sky-100 transition-colors">
