                    ...
                    <form onSubmit={handleSubmit}>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        disabled={isLoading}
                                        className={`w-full pl-10 pr-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none transition-all duration-200 ${errors.firstName ? "border-red-500" : "border-gray-300"
                                            }`}
                                        placeholder="John"
                                    />
                                </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        onChange={handleChange}
                                        disabled={isLoading}
                                        className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none transition-all duration-200 ${errors.lastName ? "border-red-500" : "border-gray-300"
                                            }`}
                                        placeholder="Doe"
                                    />
                                </div>
                        ...
                        <div className="mb-4">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    disabled={isLoading}
                                    className={`w-full pl-10 pr-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none transition-all duration-200 ${errors.email ? "border-red-500" : "border-gray-300"
                                        }`}
                        ...
                        <div className="mb-6">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    disabled={isLoading}
                                    className={`w-full pl-10 pr-12 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none transition-all duration-200 ${errors.password ? "border-red-500" : "border-gray-300"
                                        }`}
                                    placeholder="••••••••"
                                />
                                <button
                        ...
                        <div className="flex items-start mb-6">
                            <input
                                ...
                                onChange={handleChange}
                                disabled={isLoading}
                                className={`mt-1 mr-2 h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500 cursor-pointer ${errors.terms ? "border-red-500" : ""
                                    }`}
                            />
                            <label
                                htmlFor="terms"
