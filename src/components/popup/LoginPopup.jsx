            ...
            <div className="mb-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full py-2 pl-10 pr-3 border rounded-lg focus:ring-2 focus:outline-none ${
                    errors.email
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full py-2 pl-10 pr-12 border rounded-lg focus:ring-2 focus:outline-none ${
                    errors.password
                      ? "border-red-300 focus:ring-red-500 focus:border-red-500"
                      : "border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                  }`}
