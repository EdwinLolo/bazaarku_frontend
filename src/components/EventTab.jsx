...
function EventTab() {
    ...
    const handleBoothStatusUpdate = async (
        ...
        try {
            const result = await Swal.fire({
                title: `${newStatus === "APPROVED" ? "Approve" : "Reject"
                    } Application?`,
    ...
    const handleViewApplicationDetails = (application) => {
      ...
      <div style="text-align: left; margin: 20px 0;">
        ...
        <p><strong>Phone:</strong> ${application.phone ? `+${application.phone}` : "No phone provided"
                }</p>
        <p><strong>Status:</strong> <span style="color: ${application.is_acc === "APPROVED"
                    ? "#10B981"
            ...
            <Dialog
                ...
                <DialogTitle>
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex space-x-2">
                            <Chip
                                label={`${selectedEventBooths?.booth?.count || 0
                                    } Total Applications`}
                                color="primary"
                                size="small"
                            />
